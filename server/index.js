...
app.post("/api/update_bio", users.authenticate_token, userprofiles.update_bio)

app.post("/api/update_icon", users.authenticate_token, files.upload.single("icon"), userprofiles.update_icon)
